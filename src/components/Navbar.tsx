...
export default function NavigationBar() {
    ...
    return (
        <>
            <motion.nav
                className=" z-50 w-full top-4 fixed"
            ...
            >
                <div className=" relative mx-auto max-w-5xl w-[90%] px-2 py-2 bg-white rounded-full shadow-sm  border ">
                    <div className="flex justify-between items-center w-full">
                        <div className="flex items-center justify-center rounded-full border shadow-md  overflow-hidden px-0.5">
                            <img src="/logo.png" className="w-9 h-9 font-semibold" alt="Logo" />
                        </div>
                        <div className="hidden md:flex items-center  absolute left-1/2 translate-x-[-50%] justify-center  mx-auto j gap-4 text-base font-medium">
                        ...
                        <div className='flex justify-between items-center gap-2 sm:gap-5'>
                            <a href="#" className="group/button relative border shadow-md inline-flex h-10 items-center justify-center overflow-hidden rounded-full gap-2 bg-neutral-950 pl-3 pr-2 font-medium text-neutral-200">
