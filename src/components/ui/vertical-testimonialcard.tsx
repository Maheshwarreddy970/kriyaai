...
const TestimonialCard: FC<TestimonialCardProps> = ({
    ...
    return (
        <div className=' p-4 bg-black/5 shadow-inner shadow-white border rounded-2xl dark:shadow-inner dark:shadow-white/30 dark:border-neutral-90'>
        <div className="card-shadow shadow-lg bg-white  relative flex h-auto max-w-[22rem] select-none flex-col items-start justify-center overflow-hidden rounded-2xl border p-5 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl hover:-translate-y-1 ">
